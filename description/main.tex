...
\begin{abstract}
Candy is a branch of the Glucose 3 solver and is refactored towards modern C++ replacing most custom lowest-level data structures and algorithms by their C++ standard library equivalents
Several components have been improved or reimplemented.
