...
To this end, we reduced the memory footprint of clauses by shrinking the clause header, in which Candy only stores the clause's size, activity and LBD values as well as a minimal amount of flags.
