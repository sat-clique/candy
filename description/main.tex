...
We improved the architecture of clause simplification such that Candy can now perform subsumption and self-subsuming resolution during search.
Clauses of the original problem are included as well as learnt clauses that are persitent in the learnt clause database (that includes clauses of size 2 and clauses with lbd <= 2). 
