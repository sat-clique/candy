...
\begin{block}{2-Watched Literals Scheme}
\begin{itemize}
\item First Two Literals in Clause are Watched
\item Invariant: If Clause triggers unit-propagation then the first literal is the the asserted (true) literal and the second literal is the propagation trigger / the other watched literal
